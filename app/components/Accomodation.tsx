    ...
    <section id="accommodation" className="py-20 px-6 bg-[#F7F5F2]">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          ...
          <Link href="/accomodation" className="px-6 py-2 mt-12 bg-[#222222] text-white rounded-full uppercase tracking-widest text-sm hover:bg-[#D4B083] transition cursor-pointer">více informací</Link>
        </div>
      </div>
    </section>
  );
