      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start mb-16">
          <div className="space-y-10">
            ...
            <div>
              <h3 className="text-2xl font-semibold text-[#D4B083] mb-3">Doprava</h3>
              <div className="text-[#444] space-y-1 text-base">
                <p><span className="font-semibold text-[#222]">Vzdálenost od Prahy:</span> cca 120 km</p>
                <p><span className="font-semibold text-[#222]">Vzdálenost od Plzně:</span> cca 45 km</p>
                <p><span className="font-semibold text-[#222]">Nejbližší město:</span> Domažlice (15 km)</p>
                <p className="italic text-sm mt-3 text-[#666]">
                  Statek se nachází v klidném prostředí Českého lesa,
                  ideální pro svatební oslavu v přírodě.
                </p>
              </div>
            </div>
